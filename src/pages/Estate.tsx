...
const Estate = () => {
  ...
  const features = [
    ...
    { icon: featureIcons[1], title: t("estate.feature2.title"), description: t("estate.feature2.desc") },
    { icon: featureIcons[2], title: t("estate.feature3.title"), description: t("estate.feature3.desc") },
    { icon: featureIcons[3], title: t("estate.feature4.title"), description: t("estate.feature4.desc") },
  ];

  const benefits = [
    t("estate.benefit1"), t("estate.benefit2"), t("estate.benefit3"),
    t("estate.benefit4"), t("estate.benefit5"), t("estate.benefit6"),
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-foreground">
              {t("estate.hero.title1")} <span className="text-gradient-gold">{t("estate.hero.title2")}</span> {t("estate.hero.title3")}
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-semibold text-foreground">
              {t("estate.features.title1")} <span className="text-gradient-gold">{t("estate.features.title2")}</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              {t("estate.features.subtitle")}
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-semibold text-foreground">
                  {t("estate.why.title1")} <span className="text-gradient-gold">{t("estate.why.title2")}</span>
                </h2>
