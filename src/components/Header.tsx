      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <img alt="AI Byte Consult" className="h-10 w-10 rounded-lg object-cover shadow-gold" src="/lovable-uploads/b1735c02-5d33-4028-9bb9-727ffa3db32e.webp" width={128} height={128} />
