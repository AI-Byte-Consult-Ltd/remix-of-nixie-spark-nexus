...
export const translations: Record<Language, Record<string, string>> = {
  ...
  it: {
    ...
    "ecosystem.nics.desc": "L'Ecosistema NICS AI è un'infrastruttura unificata di intelligenza artificiale e blockchain progettata per connettere le industrie, automatizzare i flussi di lavoro e consentire la sincronizzazione dei dati tra piattaforme.",
    "ecosystem.horeca.title": "NICS AI HoReCa",
  ...
  bg: {
    ...
    "ecosystem.nics.desc": "NICS AI Екосистемата е обединена инфраструктура за изкуствен интелект и блокчейн, проектирана за свързване на индустриите, автоматизиране на работните потоци и синхронизация на данни между платформите.",
    "ecosystem.horeca.title": "NICS AI HoReCa",
  ...
  ru: {
    ...
    "ecosystem.nics.desc": "Экосистема NICS AI — это единая инфраструктура искусственного интеллекта и блокчейна, предназначенная для соединения отраслей, автоматизации рабочих процессов и обеспечения межплатформенной синхронизации данных.",
    "ecosystem.horeca.title": "NICS AI HoReCa",
